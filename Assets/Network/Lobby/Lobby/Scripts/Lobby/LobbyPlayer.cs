...
namespace Prototype.NetworkLobby
{
    ...
    public class LobbyPlayer : NetworkLobbyPlayer
    {
        ...
        static Color JoinColor = new Color(204.0f / 255.0f, 204.0f / 255.0f, 204.0f / 255.0f, 1.0f);
        static Color NotReadyColor = new Color(34.0f / 255.0f, 44 / 255.0f, 55.0f / 255.0f, 1.0f);
        static Color ReadyColor = new Color(204.0f / 255.0f, 204.0f / 255.0f, 204.0f / 255.0f, 1.0f);
        static Color TransparentColor = new Color(0, 0, 0, 0);

        //static Color OddRowColor = new Color(250.0f / 255.0f, 250.0f / 255.0f, 250.0f / 255.0f, 1.0f);
        //static Color EvenRowColor = new Color(180.0f / 255.0f, 180.0f / 255.0f, 180.0f / 255.0f, 1.0f);
        
        public Image img_Peon;
        ...
        public override void OnStartAuthority()
        {
            ...
            GetComponentInParent<LobbyPlayerList>().SetSelectedEvent(player1Button);
        }
        ...
        void AvatarPicker(string buttonName)
        {
            switch (buttonName)
            {
                case "Arrow_GoBoss":
                    avatarIndex = 0;
                    img_Peon.gameObject.SetActive(true);
                    img_Boss.gameObject.SetActive(false);
                    break;
                case "Arrow_GoPeon":
                    avatarIndex = 1;
                    img_Peon.gameObject.SetActive(false);
        ...
        {
            if (Input.GetButtonDown("K1_Space") || Input.GetMouseButtonDown(0))
            {
                DataManager.instance.ControllerPeon = Controller.K1;
                DataManager.instance.ControllerBoss = Controller.K1;
            }
            if (Input.GetButtonDown("J1_A"))
            {
                DataManager.instance.ControllerPeon = Controller.J1;
                DataManager.instance.ControllerBoss = Controller.J1;
            }
            if (readyState)
            {
            ...
            else
            {
                ...
                player1Button.interactable = isLocalPlayer;
                player2Button.interactable = isLocalPlayer;
            }
        }
