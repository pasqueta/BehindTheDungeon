...
public class MoneyBagText : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            text[0].text = "" + ChestBossNet.instance.NbMoneyBag;// + "      in chest : ";
        ...
        else if(ChestBoss.instance)
        {
            text[0].text = "" +ChestBoss.instance.NbMoneyBag;// + "      in chest : ";

            if (ChestBoss.instance.NbMoneyBag <= 2)
            {
                currentDt += Time.deltaTime;
                ...
                if (ChestBoss.instance.NbMoneyBag <= 1 && DataManager.instance.language == DataManager.LANGUAGE.FRANCAIS)
                {
                    text[1].text = "restant";
                }
                else
                ...
                if (ChestBoss.instance.NbMoneyBag <= 0)
                {
                    text[0].color = new Color(200 / 255f, 48 / 255f, 48 / 255f); //   C83030FF
                    text[1].color = new Color(200 / 255f, 48 / 255f, 48 / 255f);
                }
